...
public class LoginActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        final EditText txtUseripw = findViewById(R.id.txtuserpw);
        final TextView txtRegister = findViewById(R.id.txRregister);
        ...
        btnlogin.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                String userpw = txtUseripw.getText().toString();
                ...
                Response.Listener<String> responseListener = new Response.Listener<String>(){
                    ...
                    public void onResponse(String response) {
                        try {
                            ...
                            boolean success = jsonResponse.getBoolean("success"); //(boolean)map.get(success)
